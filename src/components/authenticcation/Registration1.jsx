...
const validationSchema = yup.object().shape({
  ...
  referral_id: yup
    ...
    .matches(
      /^[a-zA-Z0-9]{6}$/,
      "Invalid referral code format. It should be alphanumeric and 6 characters long"
    ),
});
...
export default function Registration1({ handleNextPage }) {
  ...
  const handleSubmit = (values) => {
    ...
    dispatch(
      createAccount(formData, setError, navigation, handleNextPage, regValues)
    );
      ...
      <View className="items-start w-full px-5 mt-11">
        ...
        >
          {({
            ...
            <>
              ...
              <View className="items-start w-full mt-6">
                ...
                <TextInput
                  ...
                  } ${!errors.phone && values.phone && "border-[#029CFC]"}`}
              ...
              <View className="items-start w-full mt-6">
                ...
                <View className="absolute bottom-[7px] left-2 flex-row w-full items-center justify-start">
                  ...
                  >
                    <Text
                      className={`text-[13px] font-["sans-regular"] text-white`}
                    >
                      Choose Image
                    </Text>
                  </TouchableOpacity>
              ...
              <View className="items-start w-full mt-6">
                ...
                <TextInput
                  className={`h-[49px] w-full pl-4 border-[1px] border-[#8A8A8A] rounded-[6px] mt-2 text-[13px] ${
                    errors.referral_id && "border-red-600"
                  } ${
                    !errors.referral_id &&
                    values.referral_id &&
                    "border-[#029CFC]"
           ...
           ${
             isValid && image !== null && !loading && check1 && check2
               ? "bg-[#029CFC]"
               : "bg-[#dddddd]"
           }  mt-4`}
              >
