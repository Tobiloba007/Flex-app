...
const HomeFeeds = () => {
  ...
  return (
    <SafeAreaView className='flex flex-col items-start justify-start w-full pb-20'>
          <Text className={'text-base text-black font-["sans-semibold"] mt-5'}>
               Feeds
          </Text>
          ...
          {feedData.map((item) => {
            return (
          <View key={item.id} className='flex flex-col items-center justify-start w-full mt-5'>
               <View className={'flex flex-row items-start justify-start w-full'}>
                    {/* LEFT*/}
                    <View className={'flex flex-col items-center justify-start w-[73px]'}>
                          {/* OWNER IMAGE*/}
                         ...
                         {/* VERTICAL BORDER*/}
                         <View className='h-6 border-[0.3px] border-[#959292] mt-[6px]'></View>
                          {/* COMMENT IMAGES*/}
                         ...
                         <View className={'flex flex-row items-end justify-start left-6'}>
                              <View className='h-6 border-[0.3px] border-[#959292] mt-[6px]'></View>
                              <View className='w-12 border-[0.3px] border-[#959292] mt-[6px]'></View>
                         </View>
                         }
                    </View>

                    {/* RIGHT */}
                    <View className={'flex flex-col items-start justify-start w-[67%] ml-4 mt-1'}>
                          {/* RIGHT TOP*/}
                          <View className={'flex flex-row items-center justify-between w-full'}>
                              <View className={'flex flex-row items-center justify-start'}>
                                  <Text numberOfLines={1} ellipsizeMode="tail"
                                  className={'text-[15px] text-black font-["sans-semibold"] mr-3'}>
                                       {item.name}
                                  </Text>
                              ...
                              <View className={'flex flex-row items-center justify-start'}>
                                  <Text className={'text-[14px] text-[#959292] font-["sans-semibold"] mr-2'}>
                                       {item.time}
                                  </Text>
                          ...
                          <View className='w-[90%]'>
                              ...
                              className={'text-xs text-[#585859] font-["sans-semibold"] mr-3'}>
                                   {item.tweet}
                              </Text>
                          </View>
                          ...
                          <View className='flex flex-row items-start justify-start mt-1'>
                               <Text className={'text-[11px] text-[#959292] font-["sans-semibold"] mr-2'}>
                          ...
                          <View className='flex flex-row items-start justify-start w-[75%] mt-2'>
                               ...
                               className={'text-[11px] text-[#585859] font-["sans-semibold"] ml-2 mt-1'}>
