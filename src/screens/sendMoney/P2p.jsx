    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content}>
            ...
            <View>
              ...
              <View style={styles.cardButtons}>
                <View style={styles.cardButtonView}>
                  <TouchableOpacity style={styles.cardButton} onPress={() => navigateToWithdrawView()}>
                ...
                <View style={styles.cardButtonView}>
                  <TouchableOpacity style={styles.cardButton} onPress={() => navigateToCoinbaseWebView()}>
                    <Ionicons name="card-outline" size={24} color="white" />
                  </TouchableOpacity>
                  <Text style={styles.cardButtonText}>Buy</Text>
                </View>
                <View style={styles.cardButtonView}>
                  <TouchableOpacity style={[styles.cardButton, { opacity: 0.6 }]} disabled={true}>
        ...
        <ScrollView horizontal={true}>
          ...
          <View style={{ width: "70%", marginLeft: 23 }}>
            <Text style={[styles.infoCardTitle, { color: "#fff" }]}>ADD FUNDS</Text>
            <Text style={[styles.infoCardSubtitle, { color: "#fff" }]}>How to Sell</Text>
            <Text style={[styles.infoCardText, { color: "#fff" }]}>
              We connect you with other buyers to swap your coins to local currency
            </Text>
            </View>
            <View style={{ width: "auto" }}>
              <Image
        ...
        <View style={{ width: "70%", marginLeft: 23 }}>
          ...
          <Text style={styles.paidCardText}>
            FlexApp is a web3-powered remittance product that allow individuals
            and businesses to send, receive, and save via stablecoin peer to
            peer. We are enabling real-time cross-border payments with multiple
            exchange rates.
            </Text>
            </View>
            <View style={{ width: "auto" }}>
